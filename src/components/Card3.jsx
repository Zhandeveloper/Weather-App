...
function Card3() {
    ...
    useEffect(() => {
      const fetchData = () => {
        fetch('https://api.weatherapi.com/v1/current.json?key=7f8a480c59e2499eb0e123435242404&q=California&aqi=no')
    ...
    return (
      <div className='box-weather'>
        <div className='card'>
          ...
          <p className='temp'>{weather ? `${Math.floor(weather.current.temp_c)}°C` : 'Загрузка...'}</p>
